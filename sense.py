...
class robot:
    ...
    def move(self, motion, tolerance=0.001): # Do not change the name of this function
        ...
        if abs(steering) > max_steering_angle:
            raise ValueError, "Angle is outside maximum range"
        
        if distance < 0.0:
            raise ValueError, "Backward going not allowed"
    ...
    # sense: 
    #    
    def sense(self, add_noise=0): #do not change the name of this function
        Z = []
