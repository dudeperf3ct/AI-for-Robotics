...
def next_move(hunter_position, hunter_heading, target_measurement, max_distance, OTHER = None):
    ...
    d = distance_between(hunter_position, xy_estimate)
    if d < max_distance:
        distance = d
    else:
...
def demo_grading(hunter_bot, target_bot, next_move_fcn, OTHER = None):
    ...
    chaser_robot.shapesize(0.7, 0.7, 0.7)
    broken_robot = turtle.Turtle()
    broken_robot.shape('turtle')
    broken_robot.color('green')
    broken_robot.resizemode('user')
    broken_robot.shapesize(0.7, 0.7, 0.7)
    ...
    measuredbroken_robot.shapesize(0.4, 0.4, 0.4)
    ...
    while not caught and ctr < 1000:
        ...
        print ('Hunter', hunter_bot.sense())
        print ('Target', target_bot.sense())
        #Visualize it
...
#         # The target continues its (nearly) circular motion.
#         target_bot.move_in_circle()
#         print ('Huneter', hunter_bot.sense())
#         print ('Target', target_bot.sense())
#         ctr += 1            
#         if ctr >= 1000:
#             print "It took too many steps to catch the target."
